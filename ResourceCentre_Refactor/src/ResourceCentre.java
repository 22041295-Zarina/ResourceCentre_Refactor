...
public class ResourceCentre {
	...
	public static final int ITEM_TYPE_CAMCORDER = 1;
	...
	public static void main(String[] args) {
		...
		while (option != OPTION_QUIT) {
			...
			if (option == OPTION_VIEW) {
				...
				} else if (itemType == ITEM_TYPE_CAMCORDER) {
					// Loan Chromebook
...
>>>>>>> branch 'master' of https://github.com/22041295-Zarina/ResourceCentre_Refactor.git
		}
		return output;
	}
